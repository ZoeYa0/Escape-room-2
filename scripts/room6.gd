...
#func _ready():
	#$tijd1.text = "Kamer 1: %.2f sec" % TimeTracker.group_times["room1"]
	#$tijd2.text = "Kamer 2: %.2f sec" % TimeTracker.group_times["room2_group"]
	#$tijd3.text = "Kamer 3: %.2f sec" % TimeTracker.group_times["room3"]
	#$tijd4.text = "Kamer 4: %.2f sec" % TimeTracker.group_times["room4"]
	#$tijd5.text = "Kamer 5: %.2f sec" % TimeTracker.group_times["room5_group"]
